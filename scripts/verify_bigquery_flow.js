...
import serviceAccount from '../data-manager/service-account.json' with { type: "json" };

// Init Firebase Admin (using data-manager key)
initializeApp({
...
async function runVerification() {
    ...
    console.log(`   👉 Check BigQuery table 'leads_raw_changelog' (if configured) or standard export.`);
    ...
    await modelRef.collection('price_history').add(historyEntry);
    ...
    console.log(`   ✅ Written to Subcollection: models/${modelId}/price_history`);
    console.log(`   👉 Check BigQuery table 'price_history_raw_changelog' (if configured).`);
