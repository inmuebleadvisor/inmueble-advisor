...
import { runOnIdle } from '../utils/deferScripts';
    ...
    init(pixelId) {
        ...
        if (typeof window !== 'undefined') {
            ...
            runOnIdle(() => {
                ...
                console.log(`✅ [MetaService] Pixel Initialized: ${pixelId} (Auto-Tracking & Auto-Events Disabled) - DEFERRED`);
            }, 3500); // Wait 3.5s or idle
        }
        /* eslint-enable */
    }
