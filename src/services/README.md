...
-   **`MetaService`**: (Frontend) Maneja la inicialización del Pixel, rastreo de eventos y generación de `event_id` para deduplicación híbrida (Pixel + CAPI). Trabaja en conjunto con `onLeadIntentMETA` para eventos de alta intención.
