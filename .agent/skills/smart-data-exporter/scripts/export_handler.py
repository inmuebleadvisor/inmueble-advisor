...
def main():
    ...
    parser.add_argument('--dest', required=True, help="Ruta de destino.")
    ...
    if os.path.exists(args.dest) and not args.force:
        print(f"ERROR: El archivo '{args.dest}' ya existe. Deteniendo para evitar sobrescritura.")
        sys.exit(1)
    ...
    try:
        ...
        print(f"SUCCESS: Datos exportados a {args.dest}")
